	...
	<div :style='{ "minHeight": "100vh", "padding": "10px 30px" }'>
		<el-form
			...
			<el-row>
				...
				<el-form-item
					:style='{ "margin": "0 0 30px 0", "flexWrap": "wrap", "textAlign": "left", "background": "none", "display": "block", "width": "100%", "justifyContent": "flex-start" }'
					v-if="flag == 'yonghu'" label="Age" prop="nianling">
					<el-input v-model="ruleForm.nianling" placeholder="Age" clearable></el-input>
				</el-form-item>
				<el-form-item
					:style='{ "margin": "0 0 30px 0", "flexWrap": "wrap", "textAlign": "left", "background": "none", "display": "block", "width": "100%", "justifyContent": "flex-start" }'
					v-if="flag == 'yonghu'" label="Avatar" prop="touxiang">
					<file-upload tip="Click to upload avatar" action="file/upload" :limit="3" :multiple="true"
						:fileUrls="ruleForm.touxiang ? ruleForm.touxiang : ''"
						@change="yonghutouxiangUploadChange"></file-upload>
				</el-form-item>
				<el-form-item
					:style='{ "margin": "0 0 30px 0", "flexWrap": "wrap", "textAlign": "left", "background": "none", "display": "block", "width": "100%", "justifyContent": "flex-start" }'
					v-if="flag == 'yonghu'" label="Mobile Phone" prop="yonghushouji">
					<el-input v-model="ruleForm.yonghushouji" placeholder="Mobile Phone" clearable></el-input>
				</el-form-item>
				<el-form-item
					:style='{ "margin": "0 0 30px 0", "flexWrap": "wrap", "textAlign": "left", "background": "none", "display": "block", "width": "100%", "justifyContent": "flex-start" }'
					v-if="flag == 'users'" label="Account" prop="username">
					<el-input v-model="ruleForm.username" placeholder="Account"></el-input>
				</el-form-item>
				<el-form-item :style='{ "width": "100%", "padding": "0", "margin": "20px 0" }'>
					<el-button
						:style='{ "cursor": "pointer", "padding": "0 34px", "margin": "0 20px 0 0", "borderColor": "#1fbfae", "color": "#1fbfae", "outline": "none", "borderRadius": "20px", "background": "#e9faf8", "borderWidth": "4px", "width": "auto", "lineHeight": "40px", "fontSize": "14px", "borderStyle": "solid double solid double", "height": "44px" }'
						type="primary" @click="onUpdateHandler">Save</el-button>
				</el-form-item>
			</el-row>
		</el-form>
	</div>
	...
	methods: {
		...
		onUpdateHandler() {
			if ((!this.ruleForm.yonghuzhanghao) && 'yonghu' == this.flag) {
				this.$message.error('User account cannot be empty');
				return
			}
			...
			if ('yonghu' == this.flag && this.ruleForm.yonghushouji && (!isMobile(this.ruleForm.yonghushouji))) {
				this.$message.error(`User's phone number should be entered in the correct phone number format`);
				return
			}
			...
			this.$http({
				...
				if (data && data.code === 0) {
					this.$message({
						message: "Successful modification of information",
						type: "success",
						duration: 1500,
						onClose: () => {
						}
